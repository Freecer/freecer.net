<!-- BEGIN: MAIN -->
<center>
 <div class="breadcrumb"><h3>{PHP.L.market_add_product_title}</h3></div>
...
<div class="customform">
	...
	<tr><td>{PRDADD_FORM_FILE}</td></tr>
	<!-- ENDIF -->

    <tr><td>Лого</td></tr>
    <tr><td>{PHP|cot_files_filebox('shop', 0, 'logo', 'image', 1)}</td></tr>
    <tr><td>Файлы</td></tr>
    <tr><td>{PHP|cot_files_filebox('shop', 0, 'gallery')}</td></tr>
