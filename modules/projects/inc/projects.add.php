...
$t->assign(array(
	...
	"PRJADD_FORM_TITLE" => cot_inputbox('text', 'rtitle', $ritem['item_title'], 'size="100"'),
	"PRJADD_FORM_ALIAS" => cot_inputbox('text', 'ralias', $ritem['item_alias'], array('size' => '32', 'maxlength' => '255')),
	"PRJADD_FORM_TEXT" => cot_textarea('rtext', $ritem['item_text'], 6, 60, 'id="formtext"', 'input_textarea_minieditor'),
