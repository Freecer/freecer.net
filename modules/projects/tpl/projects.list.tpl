...
<!-- IF {CATALOGФ} --><div class="well well-small">{CATALOG}</div><!-- ENDIF -->
...
<td colspan="4"><p class="owner small">{PRJ_ROW_SHORTTEXT}</p></td>
		...
		<!-- ELSE -->
        <center><br><img src="themes/{PHP.theme}/img/alert/icon1.png"/><h3 class="width40">{PHP.L.projects_notfound}</h3></center>
		<!-- ENDIF -->
	</div>
    <!-- BEGIN: AFTER_AJAX -->
		</div>
