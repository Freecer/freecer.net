...
<p>{USERS_DETAILS_FEMILY} {USERS_DETAILS_NIME}<span class="date">({USERS_DETAILS_NICKNAME}) {USERS_DETAILS_VRF_TITLE}</span></p>
<p><!-- IF {PHP.cot_modules.ds} --><a href="{USERS_DETAILS_ID|cot_url('ds', 'm=send&to=$this')}" class="btn btn-small">Написать сообщение</a><!-- ENDIF --></p>
</center>
