...
<td>
<p class="owner small"><span class="u_rating" title="Рейтинг - {USERS_ROW_USERPOINTS}"><span class="cur_rat" style="width: {USERS_ROW_USERPOINTS}%;"> </span></span><span class="pull-right"><img src="themes/{PHP.theme}/img/online{USERS_ROW_ONLINE}.png" /></span></p>
<p class="owner small">{USERS_ROW_COUNTRY} {USERS_ROW_COUNTRYFLAG} </p>
<p class="owner small">Отзывы:<a class=" pull-right"href="{USERS_ROW_DETAILSLINK|cot_url('users', 'm=details&id='$this'&tab=reviews')}">
...
<tr >
<td colspan="2" ><p class="owner small"><strong>{USERS_ROW_NAME}</strong></p></td>
</tr>
</table>	
<!-- END: USERS_ROW -->
</div>
			...
			<!-- ELSE -->
			<center><br><img src="themes/{PHP.theme}/img/alert/icon1.png"/><h3 class="width40">{PHP.L.Noitemsfound}</h3></center>
			<!-- ENDIF -->
		</div>
	</div>
