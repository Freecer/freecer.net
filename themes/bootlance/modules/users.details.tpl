...
<tr>
<td rowspan="3" class="center width10">{USERS_DETAILS_AVATAR}</td>
...
<br/>
	...
	<div class="span12">
		...
		<a href="{USERS_DETAILS_REVIEWS_URL}#tab_reviews" data-toggle="tab">{PHP.L.review_reviews} {USERS_DETAILS_REVIEWS_COUNT}</a></li>
		<!-- ENDIF -->
	    ...
	    <div class="span3 pull-right"><!-- IF {USERS_DETAILS_PHOTO} -->{USERS_DETAILS_PHOTO}<!-- ENDIF --></div></div></div>
		...
		<div class="tab-pane<!-- IF {PHP.tab} == 'projects' --> active<!-- ENDIF -->" id="tab_projects">{PROJECTS}</div>
