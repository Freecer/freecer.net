<!-- BEGIN: MAIN -->
<center><div class="breadcrumb">Форум</div><center>
			...
			<table class="cells">
				...
				<tr>
					<td class="{FORUMS_POSTS_ROW_ODDEVEN}">
						...
						<h4><img src="themes/{PHP.theme}/img/online{FORUMS_POSTS_ROW_USERONLINE}.png" title="{PHP.L.Status}: {FORUMS_POSTS_ROW_USERONLINETITLE}" alt="" class="userstatus" />{FORUMS_POSTS_ROW_USERNAME} <span class="seq3">{FORUMS_POSTS_ROW_UKARMA}<span></h4> 
					</td>
