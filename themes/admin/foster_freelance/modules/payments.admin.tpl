  ...
  <div class="container-fluid">
    <div class="btn-toolbar pull-left">
    	<div class="pull-right">
    		<a href="{PHP|cot_url('admin', 'm=payments')}" class="btn btn-small<!-- IF !{PHP.p} --> btn-success<!-- ENDIF -->">{PHP.L.payments_allusers}</a>
    		<a href="{PHP|cot_url('admin', 'm=payments&p=payouts')}" class="btn btn-small<!-- IF {PHP.p} == 'payouts' --> btn-success<!-- ENDIF -->">{PHP.L.payments_payouts}</a>
    	</div>
    </div>
    <!-- BEGIN: PAYMENTS -->
    <div class="widget">
        ...
        <!-- BEGIN: PAYOUT_ROW -->
     	<tr>
    		...
    		<td style="text-align: center;">
    			...
    			<a class="btn-small btn btn-warning " href="{PAYOUT_ROW_DONE_URL}">{PHP.L.Confirm}</a>
    			<!-- ENDIF -->
    		</td>
    	</tr>
        <!-- END: PAYOUT_ROW -->
