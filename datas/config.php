...
$cfg['mysqluser'] = 'freezot';			// Database user
$cfg['mysqlpassword'] = 'fDKG3d2W';			// Database password
$cfg['mysqldb'] = 'freezot';		// Database name
...
$cfg['mainurl'] = 'http://freecer.net';
$cfg['site_id'] = 'ea4d6260c2d5d8f20e81be46dec2fc5c';
$cfg['secret_key'] = '24de0cae85443c247e4e06526d306196';
...
$db_x				= ''; // Default: cot_, prefix for extra fields' table(s)
