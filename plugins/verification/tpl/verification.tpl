...
<center>
<!-- BEGIN: START -->
<div class="breadcrumb "><h4>{PHP.L.ver_txt1}</h4></div>
<p></p>
...
<div align="center">
	...
	<tr>
		<td style="text-align:center;padding:20px;" ><div align="center">
			...
			<div align="center" class="padding10" ><p>{PHP.L.ver_name1} <i class="fa fa-info-circle" title="Личность подтверждена"></i></p></div>
		...
		<td style="text-align:center;padding:20px;" >
			...
			<div align="center" class="padding10" ><p>{PHP.L.ver_name2}</p></div>
		</td>
	</tr>
	</table>
</div>
<p>{PHP.L.ver_txt2}</p>
<p>{PHP.L.ver_txt3}&nbsp;{PHP.L.ver_txt4}</p>
<p>{PHP.L.ver_txt5}</p>
<br />
<form name="confirm" action="{PHP.action}" method="post">
    <p>
		<input name="confirm" id="confirm" value="ON" type="checkbox"  onClick="if (this.checked) {document.getElementById('subconfirm').disabled = false;} else {document.getElementById('subconfirm').disabled = true;}"><br><label for="confirm" id="label_confirm" >{PHP.L.ver_confirm}</label>
    </p>
	<p>
